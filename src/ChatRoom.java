...
public class ChatRoom extends JPanel implements ActionListener {
	...
	public ChatRoom(){
		...
		// The NorthPanel with:		
		JPanel northPane = new JPanel(new GridLayout(3,1)); //Panel for the username
		...
		//Add the login, logout, and whoIsIn buttons
		...
		JPanel southPane = new JPanel(); //panel for the message
		southPane.add(login);
		southPane.add(logout);
		southPane.add(whoIsIn);
